...
function Resume() {
  return (
    <div className=" text-gray-200 p-8 mb-8">
      <div className="text-4xl font-bold mb-6 text-center"> My Resume</div>
      <div className="text-xl mb-6 mx-32 text-gray-500">
      ...
      <div className="mx-60">
        ...
        <div className="mb-10 ">
          ...
          <p className="text-center">
            <strong className="text-red-500">Dynamic and passionate </strong>{" "}
            iOS Developer with experience in mobile app development,{" "}
